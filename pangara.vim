...
nnoremap <silent> <Plug>(ctrlp) :CtrlPMRU
...
nnoremap <F5> :DeleteHiddenBuffers
vmap <D-k> ë
vmap <D-j> ê
nmap <D-k> ë
nmap <D-j> ê
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-fugitive,~/.vim/bundle/command-t,~/.vim/bundle/sparkup/vim/,~/.vim/bundle/vim-gitgutter,~/.vim/bundle/ale,~/.vim/bundle/vim-php-namespace,~/.vim/bundle/oceanic-next,~/.vim/bundle/vim-better-whitespace,~/.vim/bundle/ack.vim,~/.vim/bundle/fzf.vim,~/.vim/bundle/indentline,~/.vim/bundle/nerdtree-git-plugin,~/.vim/bundle/tabular,~/.vim/bundle/vim-delete-hidden-buffers,~/.vim/bundle/tagbar,~/.vim/bundle/AutoComplPop,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-pug,~/.vim/bundle/vim-vue,~/.vim/bundle/vim-airline,~/.vim/bundle/vim-bbye,~/.vim/bundle/rename.vim,~/.vim_runtime/sources_non_forked/ack.vim,~/.vim_runtime/sources_non_forked/ale,~/.vim_runtime/sources_non_forked/auto-pairs,~/.vim_runtime/sources_non_forked/bufexplorer,~/.vim_runtime/sources_non_forked/comfortable-motion.vim,~/.vim_runtime/sources_non_forked/ctrlp.vim,~/.vim_runtime/sources_non_forked/goyo.vim,~/.vim_runtime/sources_non_forked/gruvbox,~/.vim_runtime/sources_non_forked/lightline-ale,~/.vim_
set scrolloff=7
set shiftwidth=4
set showmatch
set showtabline=2
...
set wildignore=*.o,*~,*.pyc,*/.git/*,*/.hg/*,*/.svn/*,*/.DS_Store,*/tmp/*,*.so,*.swp,*.zip
set wildmenu
set nowritebackup
...
silent only
silent tabonly
cd ~/Projects/webapps/pan
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +22 app/Modules/UserSetting/UserSettingEntity.php
badd +36 app/Modules/UserSetting/Tests/SettingApiTest.php
badd +24 app/Modules/UserSetting/SettingManager.php
badd +18 app/Modules/UserSetting/Route.php
badd +0 app/Modules/UserSetting/Tests/SettingHandlerTest.php
argglobal
silent! argdel *
$argadd .
edit app/Modules/UserSetting/UserSettingEntity.php
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 141 + 212) / 425)
exe 'vert 2resize ' . ((&columns * 134 + 212) / 425)
exe 'vert 3resize ' . ((&columns * 148 + 212) / 425)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal tabstop=4
setlocal tagcase=
setlocal tags=~/Projects/webapps/pan/.git/tags,./tags;/
setlocal termwinkey=
...
wincmd w
argglobal
if bufexists('app/Modules/UserSetting/SettingManager.php') | buffer app/Modules/UserSetting/SettingManager.php | else | edit app/Modules/UserSetting/SettingManager.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('app/Modules/UserSetting/Tests/SettingHandlerTest.php') | buffer app/Modules/UserSetting/Tests/SettingHandlerTest.php | else | edit app/Modules/UserSetting/Tests/SettingHandlerTest.php | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((0 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
normal! 011|
lcd ~/Projects/webapps/pan
wincmd w
2wincmd w
exe 'vert 1resize ' . ((&columns * 141 + 212) / 425)
exe 'vert 2resize ' . ((&columns * 134 + 212) / 425)
